...
class UiPlugin(OctoPrintPlugin, SortablePlugin):
    ...
    `Request <https://flask.palletsprojects.com/en/2.2.x/api/#flask.Request>`_ object as
    ...
    **Preemptive and Runtime Caching**
    ...
    def will_handle_ui(self, request):
        ...
        Arguments:
            request (flask.Request): A Flask `Request <https://flask.palletsprojects.com/en/2.2.x/api/#flask.Request>`_
                object.
    ...
    def on_ui_render(self, now, request, render_kwargs):
        ...
        Arguments:
            now (datetime.datetime): The datetime instance representing "now"
                ...
                information.
            request (flask.Request): A Flask `Request <https://flask.palletsprojects.com/en/2.2.x/api/#flask.Request>`_ object.
            render_kwargs (dict): The (cached) render keyword arguments that
                would usually be provided to the core UI render function.

        Returns:
            flask.Response: Should return a Flask `Response <https://flask.palletsprojects.com/en/2.2.x/api/#flask.Response>`_
...
class SimpleApiPlugin(OctoPrintPlugin):
    ...
    full power of a `Flask Blueprint <https://flask.palletsprojects.com/en/2.2.x/blueprints/>`_ that the :class:`BlueprintPlugin`
    mixin offers.
    ...
    def on_api_get(self, request):
        ...
        received `Flask request object <https://flask.palletsprojects.com/en/2.2.x/api/#flask.Request>`_ which you may evaluate
...
class BlueprintPlugin(OctoPrintPlugin, RestartNeedingPlugin):
    ...
    The mechanism at work here is `Flask's <https://flask.palletsprojects.com/en/2.2.x/>`_ own `Blueprint mechanism <https://flask.palletsprojects.com/en/2.2.x/blueprints/>`_.
    ...
    def route(rule, **options):
        ...
        See `the documentation for flask.Blueprint.route <https://flask.palletsprojects.com/en/2.2.x/api/#flask.Blueprint.route>`_
        and `the documentation for flask.Flask.route <https://flask.palletsprojects.com/en/2.2.x/api/#flask.Flask.route>`_ for more
        information.
        """
    ...
    def errorhandler(code_or_exception):
        ...
        See `the documentation for flask.Blueprint.errorhandler <https://flask.palletsprojects.com/en/2.2.x/api/#flask.Blueprint.errorhandler>`_
        and `the documentation for flask.Flask.errorhandler <https://flask.palletsprojects.com/en/2.2.x/api/#flask.Flask.errorhandler>`_ for more
        information.
